...
//ONlY MOCK DATA
const projets = ref([
  { id: 1, titre: 'Carte interactive Québec', auteur: 'Alexis', image: '/images/map1.jpg' },
  { id: 2, titre: 'Nouvelle-France 1750', auteur: 'Raphael', image: '/images/map2.jpg' },
  { id: 3, titre: 'Carte interactive Québec', auteur: 'Alexis', image: '/images/map1.jpg' },
  { id: 4, titre: 'Nouvelle-France 1750', auteur: 'Raphael', image: '/images/map2.jpg' },
  { id: 5, titre: 'Carte interactive Québec', auteur: 'Alexis', image: '/images/map1.jpg' },
  { id: 6, titre: 'Nouvelle-France 1750', auteur: 'Raphael', image: '/images/map2.jpg' },
])
</script>
  ...
  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    ...
    <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4 mb-6">
      ...
      <div class="flex flex-1 gap-2">
        ...
        <button class="inline-flex items-center px-4 py-2 border border-gray-300 rounded-lg hover:bg-gray-100">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
      ...
      >
        <img :src="projet.image" alt="" class="w-full h-40 object-cover rounded-t-lg" />
        <div class="p-4">
