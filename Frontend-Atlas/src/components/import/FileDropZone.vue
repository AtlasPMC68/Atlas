      ...
      <div v-if="!isLoading" class="space-y-4">
        ...
        <div>
          ...
          <p class="text-base-content/70">
            ou <span class="text-primary font-medium cursor-pointer hover:underline">
...
const dropZoneClasses = computed(() => ({
  ...
  'border-base-300 bg-base-50 hover:border-primary/50 hover:bg-primary/5': !isDragOver.value && !props.isLoading,
